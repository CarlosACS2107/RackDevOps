...
export default function NetworkTopology({
    ...
    function getImg(id: string) {
        if (id === 'rack') return '/image/rack.png';
        if (id.startsWith("pc")) return "/image/PCS.png";
        if (id.startsWith("srv")) return "/image/Servidor.png";
        if (id.startsWith('cameraptz')) return '/image/CamPTZ.png';
        if (id.startsWith('camera')) return '/image/camara_ip.png';
        if (id.startsWith("cam")) return "/image/camara_ip.png";
        if (id.startsWith("printer")) return "/image/impresora.png";
        if (id.startsWith("phone")) return "/image/telefono_voip.png";
        if (id.startsWith('nas')) return '/image/NAS.png';
        if (id.startsWith('accesspoint')) return '/image/access_point.png';
        if (id.startsWith('antenaPTP')) return '/image/antPTP.png';
        if (id.startsWith('antenaPTMP')) return '/image/antPTMP.png';
        if (id.startsWith('routers')) return "/image/router.png";
