...
export default function CostEstimator({
    ...
    const totalEquipos =
        pcs + servers + cameras + phones + cameraptz + printers +
    ...
    return (
        <div>
            ...
            {loading && <p style={{ color: "white" }}>Cargando cotización...</p>}
                ...
                {equipos.map((equipo) => (
                    ...
                    >
                        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                            ...
                            />
                            <div>
                                <div style={{ color: "#e2e8f0" }}>{equipo.nombre}</div>
                                <div style={{ color: "#64748b", fontSize: 10 }}>{equipo.categoria}</div>
                            </div>
                        </div>
                        <span style={{ color: "#94a3b8" }}>x{equipo.cantidad}</span>
                        <span
                            style={{
